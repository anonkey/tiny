...
```bash
python tools/assembler/assembler.py program.asm -o program.hex
python tools/assembler/assembler.py program.asm -o program.hex -v   # verbose listing
python tools/assembler/assembler.py program.asm -d 128              # custom ROM depth
```
