...
! function(t) {
    ...
    P = Math.max, C = Math.abs, n = /left|center|right/, h = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, c = /^\w+/, p = /%$/, z = x.fn.position, x.position = {
        ...
        var u, d, f, g, m, t, v = "string" == typeof(p = x.extend({}, p)).of ? x(document).find(p.of) : x(p.of),
            _ = x.position.getWithinInfo(p.within),
            b = x.position.getScrollInfo(_),
            y = (p.collision || "flip").split(" "),
            w = {},
        ...
        return v[0].preventDefault && (p.at = "left top"), d = e.width, f = e.height, m = x.extend({}, g = e.offset), x.each(["my", "at"], function() {
            var t, e, i = (p[this] || "").split(" ");
            (i = 1 === i.length ? n.test(i[0]) ? i.concat(["center"]) : h.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = n.test(i[0]) ? i[0] : "center", i[1] = h.test(i[1]) ? i[1] : "center", t = l.exec(i[0]), e = l.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], p[this] = [c.exec(i[0])[0], c.exec(i[1])[0]]
        }), 1 === y.length && (y[1] = y[0]), "right" === p.at[0] ? m.left += d : "center" === p.at[0] && (m.left += d / 2), "bottom" === p.at[1] ? m.top += f : "center" === p.at[1] && (m.top += f / 2), u = T(w.at, d, f), m.left += u[0], m.top += u[1], this.each(function() {
            var i, t, r = x(this),
                a = r.outerWidth(),
                h = r.outerHeight(),
                e = k(this, "marginLeft"),
                s = k(this, "marginTop"),
                o = a + e + k(this, "marginRight") + b.width,
                n = h + s + k(this, "marginBottom") + b.height,
                l = x.extend({}, m),
            ...
            "right" === p.my[0] ? l.left -= a : "center" === p.my[0] && (l.left -= a / 2), "bottom" === p.my[1] ? l.top -= h : "center" === p.my[1] && (l.top -= h / 2), l.left += c[0], l.top += c[1], i = {
                ...
                d < a && C(e + i) < d && (n.horizontal = "center"), f < h && C(s + o) < f && (n.vertical = "middle"), P(C(e), C(i)) > P(C(s), C(o)) ? n.important = "horizontal" : n.important = "vertical", p.using.call(this, t, n)
            }), r.offset(x.extend(l, {
                using: t
            }))
        })
    ...
    x.expr.pseudos || (x.expr.pseudos = x.expr[":"]), x.uniqueSort || (x.uniqueSort = x.unique), x.escapeSelector || (e = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, u = function(t, e) {
    ...
    x.widget("ui.draggable", x.ui.mouse, {
        ...
        drag: function(t, e, i) {
            for (var s, o, n, r, a, h, l, c, p, u = i.options, d = u.snapTolerance, f = e.offset.left, g = f + i.helperProportions.width, m = e.offset.top, v = m + i.helperProportions.height, _ = i.snapElements.length - 1; 0 <= _; _--) h = (a = i.snapElements[_].left - i.margins.left) + i.snapElements[_].width, c = (l = i.snapElements[_].top - i.margins.top) + i.snapElements[_].height, g < a - d || h + d < f || v < l - d || c + d < m || !x.contains(i.snapElements[_].item.ownerDocument, i.snapElements[_].item) ? (i.snapElements[_].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, x.extend(i._uiHash(), {
                ...
                top: 0,
                left: h
            }).left)), p = s || o || n || r, "outer" !== u.snapMode && (s = Math.abs(l - m) <= d, o = Math.abs(c - v) <= d, n = Math.abs(a - f) <= d, r = Math.abs(h - g) <= d, s && (e.position.top = i._convertPositionTo("relative", {
                top: l,
                left: 0
            }).top), o && (e.position.top = i._convertPositionTo("relative", {
    ...
    x.widget("ui.resizable", x.ui.mouse, {
        ...
        resize: function() {
            ...
            i.grid = a, m && (u += h), s && (d += l), f && (u -= h), g && (d -= l), /^(se|s|e)$/.test(r) ? (e.size.width = u, e.size.height = d) : /^(ne)$/.test(r) ? (e.size.width = u, e.size.height = d, e.position.top = n.top - p) : /^(sw)$/.test(r) ? (e.size.width = u, e.size.height = d, e.position.left = n.left - c) : ((d - l <= 0 || u - h <= 0) && (t = e._getPaddingPlusBorderDimensions(this)), 0 < d - l ? (e.size.height = d, e.position.top = n.top - p) : (d = l - t.height, e.size.height = d, e.position.top = n.top + o.height - d), 0 < u - h ? (e.size.width = u, e.position.left = n.left - c) : (u = h - t.width, e.size.width = u, e.position.left = n.left + o.width - u))
        }
    });
    x.ui.resizable, x.widget("ui.sortable", x.ui.mouse, {
        version: "1.13.1",
        ...
        _keydown: function(t) {
            if (!t.altKey && !t.ctrlKey) {
                ...
                switch (t.keyCode) {
                    case e.RIGHT:
                    case e.DOWN:
                        o = this.headers[(s + 1) % i];
                        break;
                    case e.LEFT:
                    case e.UP:
                        o = this.headers[(s - 1 + i) % i];
                        break;
                    case e.SPACE:
                    case e.ENTER:
                ...
                o && (x(t.target).attr("tabIndex", -1), x(o).attr("tabIndex", 0), x(o).trigger("focus"), t.preventDefault())
            }
        },
        ...
        _eventHandler: function(t) {
            ...
            t.preventDefault(), o && !e.collapsible || !1 === this._trigger("beforeActivate", t, r) || (e.active = !n && this.headers.index(s), this.active = o ? x() : s, this._toggle(r), this._removeClass(i, "ui-accordion-header-active", "ui-state-active"), e.icons && (i = i.children(".ui-accordion-header-icon"), this._removeClass(i, null, e.icons.activeHeader)._addClass(i, null, e.icons.header)), o || (this._removeClass(s, "ui-accordion-header-collapsed")._addClass(s, "ui-accordion-header-active", "ui-state-active"), e.icons && (o = s.children(".ui-accordion-header-icon"), this._removeClass(o, null, e.icons.header)._addClass(o, null, e.icons.activeHeader)), this._addClass(s.next(), "ui-accordion-content-active")))
        },
        _toggle: function(t) {
            var e = t.newPanel,
        ...
        _animate: function(t, i, e) {
            ...
            return o = (o = "string" == typeof p ? p : o) || p.easing || c.easing, n = (n = "number" == typeof p ? p : n) || p.duration || c.duration, i.length ? t.length ? (s = t.show().outerHeight(), i.animate(this.hideProps, {
                duration: n,
                easing: o,
                step: function(t, e) {
                    e.now = Math.round(t)
    ...
    x.widget("ui.controlgroup", {
        ...
        _initWidgets: function() {
            ...
            x.each(this.options.items, function(s, t) {
                ...
                }), n._addClass(e, null, "ui-widget ui-widget-content ui-state-default"), void(r = r.concat(e.get()))) : void(x.fn[s] && (o = n["_" + s + "Options"] ? n["_" + s + "Options"]("middle") : {
                    classes: {}
                }, n.element.find(t).each(function() {
                    var t = x(this),
                        e = t[s]("instance"),
                        i = x.widget.extend({}, o);
                    "button" === s && t.parent(".ui-spinner").length || ((e = e || t[s]()[s]("instance")) && (i.classes = n._resolveClassesValues(i.classes, e)), t[s](i), i = t[s]("widget"), x.data(i[0], "ui-controlgroup-data", e || t[s]("instance")), r.push(i[0]))
                })))
    ...
    }), x.fn.button = (m = x.fn.button, function(i) {
        var t = "string" == typeof i,
    ...
    x.widget("ui.dialog", {
        ...
        _makeDraggable: function() {
            ...
            this.uiDialog.draggable({
                ...
                start: function(t, e) {
                    o._addClass(x(this), "ui-dialog-dragging"), o._blockFrames(), o._trigger("dragStart", t, r(e))
                },
                drag: function(t, e) {
                ...
                stop: function(t, e) {
                    ...
                    n.position = {
                        ...
                        of: o.window
                    }, o._removeClass(x(this), "ui-dialog-dragging"), o._unblockFrames(), o._trigger("dragStop", t, r(e))
                }
            })
        },
    ...
    function R(s) {
        var o = I(),
            n = o._rgba = [];
        return s = s.toLowerCase(), E(w, function(t, e) {
            var i = e.re.exec(s),
                i = i && e.parse(i),
                e = e.space || "rgba";
            if (i) return i = o[e](i), o[S[e].cache] = i[S[e].cache], n = o._rgba = i._rgba, !1
        }), n.length ? ("0,0,0,0" === n.join() && v.extend(n, V.transparent), o) : V[s]
    }

    function M(t, e, i) {
        return 6 * (i = (i + 1) % 1) < 1 ? t + (e - t) * i * 6 : 2 * i < 1 ? e : 3 * i < 2 ? t + (e - t) * (2 / 3 - i) * 6 : t
    }
    O.style.cssText = "background-color:rgba(1,1,1,.5)", W.rgba = -1 < O.style.backgroundColor.indexOf("rgba"), E(S, function(t, e) {
        ...
        parse: function(o, t, e, i) {
            ...
            var n = this,
                s = L(o),
                r = this._rgba = [];
            return void 0 !== t && (o = [o, t, e, i], s = "array"), "string" === s ? this.parse(R(o) || V._default) : "array" === s ? (E(S.rgba.props, function(t, e) {
                r[e.idx] = N(o[e.idx], e)
            }), this) : "object" === s ? (E(S, o instanceof I ? function(t, e) {
        ...
        is: function(t) {
            ...
            return E(S, function(t, e) {
                var i, s = o[e.cache];
                return s && (i = r[e.cache] || e.to && e.to(r._rgba) || [], E(e.props, function(t, e) {
        ...
        transition: function(t, r) {
            ...
            return E(i.props, function(t, e) {
                var i = e.idx,
                    ...
                    o = l[i],
                    n = D[e.type] || {};
                null !== o && (null === s ? h[i] = o : (n.mod && (o - s > n.mod / 2 ? s += n.mod : s - o > n.mod / 2 && (s -= n.mod)), h[i] = N((o - s) * r + s, e)))
            }), this[e](h)
        },
        blend: function(t) {
    ...
    })).parse.prototype = I.fn, S.hsla.to = function(t) {
        ...
        I.fn[h] = function(t) {
            ...
            I.fn[r] || (I.fn[r] = function(t) {
                var e, i = L(t),
                    s = "alpha" === r ? this._hsla ? "hsla" : "rgba" : h,
                    o = this[s](),
                    n = o[a.idx];
                return "undefined" === i ? n : ("function" === i && (i = L(t = t.call(this, n))), null == t && a.empty ? this : ("string" === i && (e = y.exec(t)) && (t = n + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), o[a.idx] = t, this[s](o)))
            })
        })
    }), (I.hook = function(t) {
        t = t.split(" ");
        E(t, function(t, n) {
            v.cssHooks[n] = {
                set: function(t, e) {
                    var i, s, o = "";
                    if ("transparent" !== e && ("string" !== L(e) || (i = R(e)))) {
                        if (e = I(i || e), !W.rgba && 1 !== e._rgba[3]) {
                ...
                t.colorInit || (t.start = I(t.elem, n), t.end = I(t.end), t.colorInit = !0), v.cssHooks[n].set(t.elem, t.start.transition(t.end, t.pos))
            }
        })
    ...
    var A, B, F, q, j, X, Y, U, K, $, V = v.Color.names = {
            aqua: "#00ffff",
            black: "#000000",
            blue: "#0000ff",
            fuchsia: "#ff00ff",
    ...
    x.effects = {
        ...
        addClass: (F = x.fn.addClass, function(t, e, i, s) {
    ...
    }), x.expr && x.expr.pseudos && x.expr.pseudos.animated && (x.expr.pseudos.animated = (X = x.expr.pseudos.animated, function(t) {
        ...
        show: (K = x.fn.show, function(t) {
            if (et(t)) return K.apply(this, arguments);
            t = tt.apply(this, arguments);
            return t.mode = "show", this.effect.call(this, t)
        }),
        hide: (U = x.fn.hide, function(t) {
            if (et(t)) return U.apply(this, arguments);
            t = tt.apply(this, arguments);
            return t.mode = "hide", this.effect.call(this, t)
        }),
        toggle: (Y = x.fn.toggle, function(t) {
            if (et(t) || "boolean" == typeof t) return Y.apply(this, arguments);
            t = tt.apply(this, arguments);
    ...
    O = x.effects, x.effects.define("blind", "hide", function(t, e) {
        var i = {
                up: ["bottom", "top"],
                vertical: ["bottom", "top"],
                down: ["top", "bottom"],
        ...
        var i, s, o = x(this),
            ...
            g = 0,
            t = o.queue().length;
        for (x.effects.createPlaceholder(o), h = o.css(d), l = l || o["top" == d ? "outerHeight" : "outerWidth"]() / 3, a && ((s = {
                opacity: 1
            })[d] = h, o.css("opacity", 0).css(d, f ? 2 * -l : 2 * l).animate(s, p, u)), r && (l /= Math.pow(2, c - 1)), (s = {})[d] = h; g < c; g++)(i = {})[d] = (f ? "-=" : "+=") + l, o.animate(i, p, u).animate(s, p, u), l = r ? 2 * l : l / 2;
        r && ((i = {
            opacity: 0
        })[d] = (f ? "-=" : "+=") + l, o.animate(i, p, u)), o.queue(e), x.effects.unshift(o, t, 1 + n)
        ...
        for (i = 0; i < h; i++)
            for (n = u.top + i * f, a = i - (h - 1) / 2, s = 0; s < l; s++) o = u.left + s * d, r = s - (l - 1) / 2, c.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: -s * d,
                top: -i * f
        ...
        var i = x(this),
            ...
            f = [p[h[0]], p[h[1]]],
            s = i.queue().length;
        a && (r = parseInt(a[1], 10) / 100 * f[n ? 0 : 1]), u.clip[h[0]] = r, d.clip[h[0]] = r, d.clip[h[1]] = 0, o && (i.cssClip(d.clip), c && c.css(x.effects.clipToBox(d)), d.clip = p), i.queue(function(t) {
            c && c.animate(x.effects.clipToBox(u), l, e.easing).animate(x.effects.clipToBox(d), l, e.easing), t()
        }).animate(u, l, e.easing).animate(d, l, e.easing).queue(t), x.effects.unshift(i, s, 4)
        ...
        x.effects.createPlaceholder(i), "show" === a && (a = f, f = g, g = a), o = {
            from: {
                y: f.height / d.height,
                x: f.width / d.width
            },
            ...
            complete: function() {
                var t = i.offset();
                0 === g.opacity && i.css("opacity", f.opacity), h || (i.css("position", "static" === p ? "relative" : p).offset(t), x.effects.saveStyle(i)), e()
            }
        })
        ...
        var i = 1,
            ...
            d = {},
            o = s.queue().length;
        for (x.effects.createPlaceholder(s), p[l] = (c ? "-=" : "+=") + n, u[l] = (c ? "+=" : "-=") + 2 * n, d[l] = (c ? "-=" : "+=") + 2 * n, s.animate(p, h, t.easing); i < r; i++) s.animate(u, h, t.easing).animate(d, h, t.easing);
        s.animate(u, h, t.easing).animate(p, h / 2, t.easing).queue(e), x.effects.unshift(s, o, 1 + a)
