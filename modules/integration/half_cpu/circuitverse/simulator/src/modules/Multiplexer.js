...
export default class Multiplexer extends CircuitElement {
    constructor(
        ...
        */
        ...
        for (let i = 0; i < this.inputSize; i++) {
            const a = new Node(-20 + this.xOff, +this.yOff * 10 * (i - this.inputSize / 2) + 10,
                0,
                this
            );
            this.inp.push(a);
    ...
    customDraw() {
        ...
        moveTo(
            ctx, -20 + this.xOff, -this.yOff * 10 * (this.inputSize / 2),
            xx,
            yy,
            this.direction
        );
        ...
        lineTo(
            ctx,
            20 - this.xOff, +this.yOff * 10 * (this.inputSize / 2 - 1) + this.xOff,
            xx,
            yy,
            this.direction
        );
        lineTo(
            ctx,
            20 - this.xOff, -this.yOff * 10 * (this.inputSize / 2) - this.xOff + 20,
            xx,
            yy,
            this.direction
        );
